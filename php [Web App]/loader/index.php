...
<center><h1>Encryption Portal</h1></center>
<center>

	Your Text <input type="text" name="text" placeholder="Enter Your Text" required/></br></br>
	
	<input class="buttom" style="  	background-color: #E5703D;border: none; color: white; padding: 15px 32px; text-align: center;
									text-decoration: none; display: inline-block; font-size: 16px;
									margin: 4px 2px; cursor: pointer; width:100%"
